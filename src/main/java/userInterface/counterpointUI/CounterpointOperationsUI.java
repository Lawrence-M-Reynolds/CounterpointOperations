package userInterface.counterpointUI;
...
public class CounterpointOperationsUI extends JFrame{
	...
	private JPanel stavePanelScroller;
	...
	public CounterpointOperationsUI(){
		super("Counterpoint Operations Interface");
	 ...
	 */
	public void setStavePanelScroller(JPanel stavePanelScroller) {
