...
import counterpointOperations.counterpointMusicRelatedEntities.MotionType;
 ...
 */
	...
	private void setAnnotationObjects(MotionRuleReport motionRuleReport, HarmonicIntervalRelationship thisHarmonicRelationship,
		...
		AnnotationObject upperVoiceAnnotationObject = new AnnotationObject();
		...
		AnnotationObject lowerVoiceAnnotationObject = new AnnotationObject();
	...
	private class MotionRuleReport extends RuleReport{
		private AnnotationObject upperVoiceAnnotationObject;
		private AnnotationObject lowerVoiceAnnotationObject;
		...
		public void setUpperVoiceAnnotationObject(
				AnnotationObject upperVoiceAnnotationObject) {
		...
		public void setLowerVoiceAnnotationObject(
				AnnotationObject lowerVoiceAnnotationObject) {
